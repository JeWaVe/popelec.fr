...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: locale === 'fr' ? 'Conditions Générales de Vente | popelec.fr' : 'Terms & Conditions | popelec.fr',
  }
}
    ...
    <div className="max-w-4xl mx-auto px-6 py-8">
      ...
      <div className="prose prose-neutral max-w-none">
        {content ? (
          ...
          <div>
            <h2>{locale === 'fr' ? 'Article 1 - Objet' : 'Article 1 - Purpose'}</h2>
            <p>
              {locale === 'fr'
            ...
            <h2>{locale === 'fr' ? 'Article 2 - Prix' : 'Article 2 - Prices'}</h2>
            <p>
              {locale === 'fr'
            ...
            <h2>{locale === 'fr' ? 'Article 3 - Commande' : 'Article 3 - Orders'}</h2>
            <p>
              {locale === 'fr'
            ...
            <h2>{locale === 'fr' ? 'Article 4 - Droit de rétractation' : 'Article 4 - Right of withdrawal'}</h2>
            <p>
              {locale === 'fr'
            ...
            <h2>{locale === 'fr' ? 'Article 5 - Livraison' : 'Article 5 - Delivery'}</h2>
            <p>
              {locale === 'fr'
            ...
            <h2>{locale === 'fr' ? 'Article 6 - Garanties' : 'Article 6 - Warranties'}</h2>
            <p>
              {locale === 'fr'
