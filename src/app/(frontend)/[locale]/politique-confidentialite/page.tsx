...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: locale === 'fr' ? 'Politique de confidentialité | popelec.fr' : 'Privacy policy | popelec.fr',
  }
}
    ...
    <div className="max-w-4xl mx-auto px-6 py-8">
      ...
      <div className="prose prose-neutral max-w-none">
        {content ? (
          ...
          <div>
            <h2>{locale === 'fr' ? 'Responsable du traitement' : 'Data controller'}</h2>
            <p>
              <strong>Électricité Populaire d&apos;Aucamville</strong><br />
              Email : contact@popelec.fr
            </p>

            <h2>{locale === 'fr' ? 'Données collectées' : 'Data collected'}</h2>
            <p>
              {locale === 'fr'
            ...
            <h2>{locale === 'fr' ? 'Finalité du traitement' : 'Purpose of processing'}</h2>
            <p>
              {locale === 'fr'
            ...
            <h2>{locale === 'fr' ? 'Base légale' : 'Legal basis'}</h2>
            <p>
              {locale === 'fr'
            ...
            <h2>{locale === 'fr' ? 'Durée de conservation' : 'Retention period'}</h2>
            <p>
              {locale === 'fr'
            ...
            <h2>{locale === 'fr' ? 'Vos droits' : 'Your rights'}</h2>
            <p>
              {locale === 'fr'
            ...
            <h2>{locale === 'fr' ? 'Sous-traitants' : 'Third-party processors'}</h2>
            <p>
              {locale === 'fr'
